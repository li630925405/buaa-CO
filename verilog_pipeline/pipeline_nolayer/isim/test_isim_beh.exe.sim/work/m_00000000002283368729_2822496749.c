...
#endif
static const char *ng0 = "E:/homework/CC/verilog_pipeline/pipeline_nolayer/main_ctrl.v";
...
LAB74:    t470 = (t0 + 6712);
    ...
    *((unsigned int *)t480) = (t482 | t476);
    xsi_driver_vfirst_trans(t470, 0, 4);
    t483 = (t0 + 6392);
    *((int *)t483) = 1;
...
LAB102:    memcpy(t380, t341, 8);

LAB103:    memset(t255, 0, 8);
    t408 = (t380 + 4);
...
LAB118:    t415 = (t255 + 4);
    t416 = *((unsigned int *)t255);
    t417 = *((unsigned int *)t415);
    t418 = (t416 || t417);
    if (t418 > 0)
        goto LAB119;

LAB120:    t429 = *((unsigned int *)t255);
    t430 = (~(t429));
...
LAB124:    if (*((unsigned int *)t255) > 0)
        goto LAB125;

LAB126:    memcpy(t254, t433, 8);

LAB127:    goto LAB69;

LAB70:    xsi_vlog_unsigned_bit_combine(t3, 32, t240, 32, t254, 32);
    goto LAB74;
...
LAB87:    *((unsigned int *)t289) = 1;

LAB89:    memset(t305, 0, 8);
    t306 = (t289 + 4);
...
LAB129:    *((unsigned int *)t437) = 1;

LAB131:    memset(t434, 0, 8);
    t453 = (t437 + 4);
...
LAB141:    if (*((unsigned int *)t434) > 0)
        goto LAB142;

LAB143:    memcpy(t433, t469, 8);

LAB144:    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t254, 32, t419, 32, t433, 32);
    goto LAB127;

LAB125:    memcpy(t254, t419, 8);
    goto LAB127;
...
LAB136:    t464 = ((char*)((ng7)));
    goto LAB137;

LAB138:    t469 = ((char*)((ng2)));
    goto LAB139;

LAB140:    xsi_vlog_unsigned_bit_combine(t433, 32, t464, 32, t469, 32);
    goto LAB144;

LAB142:    memcpy(t433, t464, 8);
    goto LAB144;
...
LAB67:    memcpy(t266, t227, 8);

LAB68:    memset(t294, 0, 8);
    t295 = (t266 + 4);
...
LAB122:    t495 = (t0 + 6904);
    ...
    *((unsigned int *)t505) = (t507 | t501);
    xsi_driver_vfirst_trans(t495, 0, 0);
    t508 = (t0 + 6440);
    *((int *)t508) = 1;
...
LAB86:    xsi_vlog_unsigned_bit_combine(t211, 32, t242, 32, t247, 32);
    goto LAB90;
...
LAB47:    t136 = ((char*)((ng10)));
    goto LAB48;

LAB49:    t141 = ((char*)((ng2)));
    goto LAB50;

LAB51:    xsi_vlog_unsigned_bit_combine(t105, 32, t136, 32, t141, 32);
    goto LAB55;
...
extern void work_m_00000000002283368729_2822496749_init()
{
	static char *pe[] = {(void *)Cont_46_0,(void *)Cont_47_1,(void *)Cont_48_2,(void *)Cont_53_3,(void *)Cont_54_4,(void *)Cont_57_5,(void *)Cont_58_6,(void *)Cont_59_7,(void *)Cont_63_8,(void *)Cont_66_9};
	xsi_register_didat("work_m_00000000002283368729_2822496749", "isim/test_isim_beh.exe.sim/work/m_00000000002283368729_2822496749.didat");
